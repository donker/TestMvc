...
namespace Bring2mind.TestMvc.TestMvc.Common
{
    ...
    public class TestMvcAuthorizeAttribute : AuthorizeAttributeBase, IOverrideDefaultAuthLevel
    {
        private static readonly ILog Logger = LoggerSource.Instance.GetLogger(typeof(TestMvcAuthorizeAttribute));
        public SecurityAccessLevel SecurityLevel { get; set; }
        public UserInfo User { get; set; }

        public TestMvcAuthorizeAttribute()
        {
            SecurityLevel = SecurityAccessLevel.Admin;
        }

        public TestMvcAuthorizeAttribute(SecurityAccessLevel accessLevel)
        {
